...
export const createApp = ({ productModel, providorModel, editorialModel, passwordModel, partyModel, genreModel, subgenreModel, employeeModel, fullproductsModel, shopModel, discountModel, ticketsModel }) => {
  const app = express();
  ...
  app.use('/shop', createShopRouter({ partyModel, shopModel, fullproductsModel, discountModel, ticketsModel }));
