...
export const createApp = ({ productModel, providorModel, editorialModel, passwordModel, partyModel, genreModel, subgenreModel, employeeModel, fullproductsModel, shopModel, discountModel }) => {
  const app = express();
  ...
  app.use('/shop', createShopRouter({ partyModel, shopModel, fullproductsModel, discountModel }));
